...
module Refer
  class RunnerTest < ReferTest
    ...
    def test_fixture_1
      ...
      # line 2: module Bar
      assert_includes tokens, token_for(:Bar, :double_colon, 2, 7)
      # line 10: class Foo
      assert_includes tokens, token_for(:Foo, :double_colon, 10, 8)
      # line 22: Bar.baz
      assert_includes tokens, bar = token_for(:Bar, :constant_ref, 22, 0)
      assert_includes tokens, token_for(:baz, :call, 22, 0, bar)
      # line 24: puts "#{Bar::Foo::THINGS}!"
      assert_includes tokens, bar = token_for(:Bar, :constant_ref, 24, 8)
      assert_includes tokens, foo = token_for(:Foo, :double_colon, 24, 8, bar)
      assert_includes tokens, token_for(:THINGS, :double_colon, 24, 8, foo)
      # line 26: Bar::Foo.new.fiz
      assert_includes tokens, bar = token_for(:Bar, :constant_ref, 26, 0)
      assert_includes tokens, foo = token_for(:Foo, :double_colon, 26, 0, bar)
      assert_includes tokens, new = token_for(:new, :call, 26, 0, foo)
